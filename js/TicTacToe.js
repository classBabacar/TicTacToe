...
class TicTacToe {
  ...
  boxSelection (canvasX, canvasY) {
    ...
    if (canvasY <= 200 && canvasY >= 0) {
      if (canvasX <= 200) {
        return 1
      } else if (canvasX > 200 && canvasX <= 400) {
        return 2
      } else if (canvasX > 400 && canvasX > 400 <= 600) {
        return 3
      }
    }
    // Middle Row
    else if (canvasY > 200 && canvasY <= 400) {
      if (canvasX <= 200) {
        return 4
      } else if (canvasX > 200 && canvasX <= 400) {
        return 5
    ...
    // Last Row
    else if (canvasY > 400 && canvasY <= 600) {
      if (canvasX <= 200) {
        return 7
      } else if (canvasX > 200 && canvasX <= 400) {
        return 8
  ...
  whereToDrawWinningLine (board, moveNumber) {
    ...
    const topLeftToBottomRight = 6
    const topRightToBottomLeft = 7
